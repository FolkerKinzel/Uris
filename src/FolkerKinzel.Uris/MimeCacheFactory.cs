...
namespace FolkerKinzel.Uris
{
    ...
    public static class MimeCacheFactory
    {
        ...
        {
            var dic = new ConcurrentDictionary<string, string>(StringComparer.Ordinal);
        ...
        public static void TestIt()
        {
            ...
            error = mimeTypeCache.FirstOrDefault(kvp => kvp.Key.Contains(' ', StringComparison.Ordinal) || kvp.Key.Contains('.', StringComparison.Ordinal)).Key;
