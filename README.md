...
embeds data in-line in a URL-string. DataUrlBuilder creates a "data" URL-string from 
the data to embed. This can be either a file or a byte array or a string. 
  - The `DataUrlInfo` structure allows to retrieve the data from a "data" URL-string and to find 
