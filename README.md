...
[Project Reference and Release Notes](https://github.com/FolkerKinzel/Uris/releases/tag/v4.0.0-beta.1)
...
public static class DataUrlExample
{
    ...
    private static string CreatePhotoFile()
    {
        ...
        if (DataUrl.TryGetEmbeddedData(url, out OneOf<string, byte[]> data, out string? fileTypeExtension) && data.Value is byte[] bytes)
        {
